...
var (
	...
	authorsFileHeader = "# This is the official list of go-ethereum/go-nekonium authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-ethereum/go-nekonium Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-nekonium library"
	}
	return "the go-nekonium library"
}
