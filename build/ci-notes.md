...
We want to build go-nekonium with the most recent version of Go, irrespective of the Go
...
Then go into the source package directory for your running distribution and build the package:
    ...
    $ cd dist/nekonium-unstable-1.6.0+xenial
    $ dpkg-buildpackage

Built packages are placed in the dist/ directory.

    $ cd ..
    $ dpkg-deb -c gnekonium-unstable_1.6.0+xenial_amd64.deb
