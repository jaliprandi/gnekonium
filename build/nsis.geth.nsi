...
# 1. install gnekonium for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gnekonium
# 5. create gnekonium, attach and uninstall start menu entries
...
!define APPNAME "Gnekonium"
!define DESCRIPTION "Official Go implementation of the Nekonium protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gnekonium is installed global
